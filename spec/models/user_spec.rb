...
RSpec.describe User, type: :model do
  ...
  describe "order_by_name" do
    let!(:demo1){FactoryGirl.create(:user, name:"hung", email: "hung@gmail.com", address: "ha noi", phone: "0934589868",password: "123456")}
    let!(:demo2){FactoryGirl.create(:user, name:"tuan", email: "tuan@gmail.com", address: "ha noi", phone: "0934589868",password: "123456")}
